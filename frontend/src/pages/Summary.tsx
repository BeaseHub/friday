...
const Summary = () => {
  ...
  if (selectedAgents.length === 0) {
    return (
      <div className="min-h-screen" style={{background: 'linear-gradient(to bottom right, #D2840C, #B8740A, #A0630A)'}}>
        <Header />
        <main className="container mx-auto px-6 py-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-white mb-4">Aucun agent sélectionné</h1>
            <p className="text-white/80 mb-8">Retournez à la page d'exploration pour choisir vos agents IA.</p>
            <Button
